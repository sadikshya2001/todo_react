...
const page = () => {
      ...
      return (
        <li key={i} className='flex items-center justify-between mb-8'>
          ...
          <button 
            ...
            className='bg-green-400 text-white px-4 py-2 rounded font-bold'>DONE
          </button>
        </li>
      );
    });
  ...
  return (
    ...
    <form onSubmit={submitHandler} className='flex items-center justify-center mx-auto space-x-4 w-full'>
